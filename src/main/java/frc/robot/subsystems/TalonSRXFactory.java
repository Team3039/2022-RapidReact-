...
/**
 * Creates TalonSRX objects and configures all the parameters we care about to
...
public class TalonSRXFactory {
    ...
    public static class Configuration {
        ...
        public double EXPIRATION_TIMEOUT_SECONDS = 0.1;
    ...
    public static void initializeTalon(TalonSRX talon, Configuration config) {
        // talon.setControlFramePeriod(config.CONTROL_FRAME_PERIOD_MS,
        ...
        talon.setStatusFramePeriod(StatusFrame.Status_4_AinTempVbat, config.ANALOG_TEMP_VBAT_STATUS_FRAME_RATE_MS);
    ...
    public static String getFullTalonInfo(TalonSRX talon) {
        ...
        // ").append(talon.getMotionProfileTopLevelBufferCount())
        // .append("\n").append("getNumberOfQuadIdxRises =
        // ").append(talon.getNumberOfQuadIdxRises()).append("\n")
        // .append("getInverted = ").append(talon.getInverted()).append("\n")
        // .append("getPulseWidthRiseToRiseUs =
        // ").append(talon.getPulseWidthRiseToRiseUs()).append("\n")
        // .append("getError =
        // ").append(talon.getError()).append("\n").append("isSensorPresent = ")
        // .append(talon.isSensorPresent(CANTalon.FeedbackDevice.CtreMagEncoder_Relative)).append("\n")
        // .append("isControlEnabled =
        // ").append(talon.isControlEnabled()).append("\n").append("getTable = ")
        // .append(talon.getTable()).append("\n").append("isEnabled =
        // ").append(talon.isEnabled()).append("\n")
        // .append("isZeroSensorPosOnRevLimitEnabled =
        // ").append(talon.isZeroSensorPosOnRevLimitEnabled())
        // .append("\n").append("isSafetyEnabled =
        // ").append(talon.isSafetyEnabled()).append("\n")
        // .append("getOutputVoltage =
        // ").append(talon.getOutputVoltage()).append("\n").append("getTemperature = ")
        ...
        // ").append(talon.get()).append("\n")
        // .append("isZeroSensorPosOnIndexEnabled =
        // ").append(talon.isZeroSensorPosOnIndexEnabled()).append("\n")
        // .append("getMotionMagicCruiseVelocity =
        // ").append(talon.getMotionMagicCruiseVelocity()).append("\n")
        // .append("getStickyFaultRevSoftLim =
        // ").append(talon.getStickyFaultRevSoftLim()).append("\n")
        // .append("getFaultRevLim =
        // ").append(talon.getFaultRevLim()).append("\n").append("getEncPosition = ")
        // .append(talon.getEncPosition()).append("\n").append("getIZone =
        // ").append(talon.getIZone()).append("\n")
        // .append("getAnalogInPosition =
        // ").append(talon.getAnalogInPosition()).append("\n")
        // .append("getFaultUnderVoltage =
        // ").append(talon.getFaultUnderVoltage()).append("\n")
        // .append("getCloseLoopRampRate =
        // ").append(talon.getCloseLoopRampRate()).append("\n")
        ...
        // ").append(talon.getClass())
        // .append("\n").append("getAnalogInVelocity =
        // ").append(talon.getAnalogInVelocity()).append("\n")
        // .append("getI =
        // ").append(talon.getI()).append("\n").append("isReverseSoftLimitEnabled = ")
        ...
        // ").append(talon.GetVelocityMeasurementWindow())
        // .append("\n").append("getDeviceID =
        // ").append(talon.getDeviceID()).append("\n")
        // .append("getStickyFaultRevLim =
        // ").append(talon.getStickyFaultRevLim()).append("\n")
        // // .append("getMotionMagicActTrajVelocity =
        // // ").append(talon.getMotionMagicActTrajVelocity()).append("\n")
        // .append("getReverseSoftLimit =
        // ").append(talon.getReverseSoftLimit()).append("\n").append("getD = ")
        // .append(talon.getD()).append("\n").append("getFaultOverTemp =
        // ").append(talon.getFaultOverTemp())
        // .append("\n").append("getForwardSoftLimit =
        // ").append(talon.getForwardSoftLimit()).append("\n")
        // .append("GetFirmwareVersion =
        // ").append(talon.GetFirmwareVersion()).append("\n")
        // .append("getLastError =
        // ").append(talon.getLastError()).append("\n").append("isAlive = ")
        // .append(talon.isAlive()).append("\n").append("getPinStateQuadIdx =
        // ").append(talon.getPinStateQuadIdx())
        // .append("\n").append("getAnalogInRaw =
        // ").append(talon.getAnalogInRaw()).append("\n")
        // .append("getFaultForLim =
        // ").append(talon.getFaultForLim()).append("\n").append("getSpeed = ")
        ...
        // ").append(talon.hashCode()).append("\n")
        // .append("isFwdLimitSwitchClosed =
        // ").append(talon.isFwdLimitSwitchClosed()).append("\n")
        // .append("getPinStateQuadA = ").append(talon.getPinStateQuadA()).append("\n")
        // .append("getPinStateQuadB =
        // ").append(talon.getPinStateQuadB()).append("\n").append("GetIaccum = ")
        ...
        // ").append(talon.getBrakeEnableDuringNeutral())
        // .append("\n").append("getStickyFaultUnderVoltage =
        // ").append(talon.getStickyFaultUnderVoltage())
        // .append("\n").append("getPulseWidthVelocity =
        // ").append(talon.getPulseWidthVelocity()).append("\n")
        // .append("GetNominalClosedLoopVoltage =
        // ").append(talon.GetNominalClosedLoopVoltage()).append("\n")
        // .append("getPosition =
        // ").append(talon.getPosition()).append("\n").append("getExpiration = ")
        ...
        // ").append(talon.getMotionMagicAcceleration()).append("\n")
