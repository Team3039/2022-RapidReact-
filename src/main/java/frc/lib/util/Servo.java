...
// I copied the WPIlib servo class and added the ability to set angle limits
...
public class Servo extends PWM {
   ...
   *
   * @param minAngle minimum angle limit.
   * @param maxAngle maximun angle limit.
   */
  public void setAngleLimits(double minAngle, double maxAngle) {
      kDefaultMinServoPWM = minAngle;
      kDefaultMaxServoPWM = maxAngle;
  }
